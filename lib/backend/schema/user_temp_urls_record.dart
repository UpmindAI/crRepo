...
class UserTempUrlsRecordDocumentEquality
    implements Equality<UserTempUrlsRecord> {
  const UserTempUrlsRecordDocumentEquality();

  @override
  bool equals(UserTempUrlsRecord? e1, UserTempUrlsRecord? e2) {
  ...
  @override
  int hash(UserTempUrlsRecord? e) => const ListEquality().hash([
        e?.docTitle,
        e?.docId,
        e?.datasetName,
        e?.datasetId,
  ...
  @override
  bool isValidKey(Object? o) => o is UserTempUrlsRecord;
}
