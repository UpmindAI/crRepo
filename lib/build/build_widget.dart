...
class _BuildWidgetState extends State<BuildWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BuildModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'build'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('BUILD_PAGE_build_ON_INIT_STATE');
      logFirebaseEvent('build_update_app_state');
      setState(() {
