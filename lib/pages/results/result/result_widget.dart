...
class _ResultWidgetState extends State<ResultWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Result'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('RESULT_PAGE_Result_ON_INIT_STATE');
      logFirebaseEvent('Result_update_app_state');
      setState(() {
                                                        ...
                                                        Row(
                                                          ...
                                                          children: [
                                                            InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'RESULT_PAGE_Container_ko6twdcc_ON_TAP');
                                                                logFirebaseEvent(
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'RESULT_PAGE_CONTINUE_PROMPT_BTN_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Button_navigate_to');
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'RESULT_PAGE_START_NEW_PROMPT_BTN_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Button_navigate_to');
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'RESULT_PAGE_GENERATE_DOCX_BTN_ON_TAP');
                                                              logFirebaseEvent(
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child:
                                                              ...
                                                              onPressed:
                                                                  () async {
                                                                logFirebaseEvent(
                                                                    'RESULT_PAGE_DOWNLOAD_DOCX_BTN_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Button_launch_u_r_l');
                                                                await launchURL(
                                                                    columnUserCompletionsRecord!
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'RESULT_PAGE_Icon_hfhp3b96_ON_TAP');
                                                        logFirebaseEvent(
                                                  ...
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'RESULT_PAGE_Text_f6sls8k0_ON_TAP');
                                                      logFirebaseEvent(
                                                      ...
                                                      child: Align(
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'RESULT_PAGE_Icon_mvf4ec9z_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Icon_update_app_state');
                                                              setState(() {
                                                                FFAppState()
