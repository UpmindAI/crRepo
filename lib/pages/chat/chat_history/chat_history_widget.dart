...
class ChatHistoryWidget extends StatefulWidget {
  const ChatHistoryWidget({Key? key}) : super(key: key);
                ...
                Padding(
                  ...
                  child: StreamBuilder<List<ChatMetaRecord>>(
                    stream: queryChatMetaRecord(
                      ...
                      queryBuilder: (chatMetaRecord) => chatMetaRecord
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<ChatMetaRecord> listViewChatMetaRecordList =
                          snapshot.data!;
                      return ListView.builder(
                        ...
                        itemCount: listViewChatMetaRecordList.length,
                          ...
                          return Align(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'CHAT_HISTORY_Container_53dg6rjk_ON_TAP');
                                  logFirebaseEvent(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'CHAT_HISTORY_COMP_Icon_zm4isgq8_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Icon_backend_call');
                                                    await listViewChatMetaRecord
                                                        .reference
                                                        .delete();
                                                  },
                                                  child: FaIcon(
