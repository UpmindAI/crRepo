...
class ConfigureBotWidget extends StatefulWidget {
  ...
  final ChatMetaRecord? chatMetadoc;
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                child: Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'CONFIGURE_BOT_COMP_Icon_i3wj1q7h_ON_TAP');
                          ...
                          if (FFAppState().setChatDropdown == 'My Data Only')
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 10.0, 0.0, 0.0),
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Switch(
                                        value: _model.costumGuardrailValue ??=
                                            FFAppState().grOn,
                                        onChanged: (newValue) async {
                                          ...
                                          if (newValue!) {
                                            logFirebaseEvent(
                                                'CONFIGURE_BOT_CostumGuardrail_ON_TOGGLE_');
                                            logFirebaseEvent(
                                                'CostumGuardrail_update_app_state');
                                            setState(() {
                                              FFAppState().grOn = true;
                                              FFAppState().setChatGR = 'yes';
                                            });
                                          } else {
                                            logFirebaseEvent(
                                                'CONFIGURE_BOT_CostumGuardrail_ON_TOGGLE_');
                                            logFirebaseEvent(
                                                'CostumGuardrail_update_app_state');
                                            setState(() {
                                              FFAppState().grOn = false;
                                              FFAppState().setChatGR = 'no';
                                            });
                                            logFirebaseEvent(
                                      ...
                                      child: AuthUserStreamWidget(
                                        builder: (context) => TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            hintText:
                                                'Customize your guardrail (completion confinement / hallucination control).',
                                            hintStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodySmall
                                                    .override(
                                            ...
                                            Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                onChanged: (_) =>
                                                  ...
                                                  () async {
                                                    logFirebaseEvent(
                                                        'CONFIGURE_BOT_topK_ON_TEXTFIELD_CHANGE');
                                                    logFirebaseEvent(
                                                        'topK_update_app_state');
                                                    setState(() {
                                                      FFAppState().setTopKchat =
                                                          int.parse(_model
                                                              .topKController
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'CONFIGURE_BOT_COMP_Icon_fj0k7520_ON_TAP');
                                                          logFirebaseEvent(
                                                    ...
                                                    Stack(
                                                      ...
                                                      children: [
                                                            ...
                                                            children: [
                                                              InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'CONFIGURE_BOT_COMP_Icon_1p5tmh35_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Icon_backend_call');
                                                        ...
                                                        InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'CONFIGURE_BOT_COMP_Card_v9awsrw1_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Card_upload_media_to_firebase');
                                                            final selectedMedia =
                                                                await selectMedia(
                                                              maxWidth: 500.00,
                                                              maxHeight: 500.00,
                                      ...
                                      Container(
                                        ...
                                        child: Align(
                                          alignment:
                                              AlignmentDirectional(-1.0, 0.0),
                                          child: Switch(
                                            value: _model.persSwitchValue ??=
                                                FFAppState().chatPersSwitch,
                                            onChanged: (newValue) async {
                                              setState(() => _model
                                                  .persSwitchValue = newValue!);
                                              if (newValue!) {
                                                logFirebaseEvent(
                                                    'CONFIGURE_BOT_persSwitch_ON_TOGGLE_ON');
                                                logFirebaseEvent(
                                                    'persSwitch_update_app_state');
                                                setState(() {
                                                  FFAppState().chatPersSwitch =
                                                      true;
                                                });
                                                ...
                                                logFirebaseEvent(
                                                    'CONFIGURE_BOT_persSwitch_ON_TOGGLE_OFF');
                                                logFirebaseEvent(
                                                    'persSwitch_update_app_state');
                                                setState(() {
                                                  FFAppState().chatPersSwitch =
