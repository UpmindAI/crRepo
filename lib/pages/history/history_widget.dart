...
class _HistoryWidgetState extends State<HistoryWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('History_update_app_state');
      setState(() {
                                                        ...
                                                        children: [
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'HISTORY_PAGE_Text_smg7cb1q_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Text_navigate_to');
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'HISTORY_PAGE_Icon_blh7skwj_ON_TAP');
                                                                logFirebaseEvent(
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'HISTORY_PAGE_Icon_2brev3f1_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_backend_call');
