                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'BOT_LIST_COMP_Icon_7n5jilf3_ON_TAP');
                                                  ...
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'BOT_LIST_COMP_Icon_tf7biizo_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Icon_launch_u_r_l');
                                                          await launchURL(
                                                              columnSharedBotsRecord
                                                      ...
                                                      Padding(
                                                        ...
                                                        child:
                                                          ...
                                                          builder: (context) =>
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'BOT_LIST_COMP_Icon_zzblvj7s_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Icon_launch_u_r_l');
                                                              await launchURL(
                                                                  'https://t.me/MyPaalBot?start=${columnSharedBotsRecord.bid}');
                                                            },
                                                            child: FaIcon(
                                                              FontAwesomeIcons
                                                                  .telegramPlane,
