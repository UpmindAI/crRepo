...
class FreeTrialWidget extends StatefulWidget {
  const FreeTrialWidget({Key? key}) : super(key: key);

  @override
  _FreeTrialWidgetState createState() => _FreeTrialWidgetState();
}
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      '10 free credits where added to your account!',
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('FREE_TRIAL_COMP_PLAY_BTN_ON_TAP');
