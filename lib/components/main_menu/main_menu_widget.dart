                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    if (valueOrDefault<bool>(
                                            currentUserDocument?.whitelabel,
                                            false) &&
                                        (valueOrDefault(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: FaIcon(
                                ...
                                color: FFAppState().currentPage == 'Summarize'
                                    ? FlutterFlowTheme.of(context).accentOne
                                    : FlutterFlowTheme.of(context).grayIcon,
                                size: 28.0,
                              ).animateOnPageLoad(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: FaIcon(
                                ...
                                color: FFAppState().currentPage == 'promptLab'
                                    ? FlutterFlowTheme.of(context).accentOne
                                    : FlutterFlowTheme.of(context).grayIcon,
                                size: 28.0,
                              ).animateOnPageLoad(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: FaIcon(
                                ...
                                color: FFAppState().currentPage == 'History'
                                    ? FlutterFlowTheme.of(context).accentOne
                                    : FlutterFlowTheme.of(context).grayIcon,
                                size: 28.0,
                              ).animateOnPageLoad(
                                ...
                                style: FlutterFlowTheme.of(context)
                                    ...
                                    .override(
                                      fontFamily: FlutterFlowTheme.of(context)
                                          .titleSmallFamily,
                                      color:
                                          FFAppState().currentPage == 'History'
                                              ? FlutterFlowTheme.of(context)
                                                  .accentOne
                                              : FlutterFlowTheme.of(context)
                                                  .secondaryText,
                  ...
                  Padding(
                    ...
                    child: AuthUserStreamWidget(
                      builder: (context) => InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'MAIN_MENU_COMP_contentView_1_ON_TAP');
                          logFirebaseEvent('contentView_1_navigate_to');

                          context.pushNamed('searchTest');
                        },
                        child: Container(
                          width: double.infinity,
                          height: 50.0,
                      ...
                      children: [
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'MAIN_MENU_COMP_Container_4dz6fsjn_ON_TAP');
                                            logFirebaseEvent(
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'MAIN_MENU_COMP_Icon_fti714k2_ON_TAP');
                                              logFirebaseEvent(
                                                  'Icon_navigate_to');
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'MAIN_MENU_COMP_Container_r9dfl890_ON_TAP');
                                            logFirebaseEvent(
                                                'Container_set_dark_mode_settings');
                                            setDarkModeSetting(
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'MAIN_MENU_COMP_Icon_jdijlpi7_ON_TAP');
                                              logFirebaseEvent(
                                                  'Icon_navigate_to');
                        ...
                        Align(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'MAIN_MENU_COMP_Container_22h4b70g_ON_TAP');
                            ...
                            children: [
                              AuthUserStreamWidget(
                                builder: (context) => InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'MAIN_MENU_COMP_Image_0twc4ril_ON_TAP');
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: AuthUserStreamWidget(
                                          builder: (context) => InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'MAIN_MENU_COMP_Text_x4kmrlnq_ON_TAP');
                                              logFirebaseEvent(
                                                  'Text_navigate_to');
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'MAIN_MENU_COMP_Text_3udzduwl_ON_TAP');
